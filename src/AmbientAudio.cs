...
public class AmbientAudio : AudioStreamPlayer2D {
	...
	[Export]
	private Vector2 lastPosition = new Vector2(-1000, -1000); // Initial lastPosition should be the closest point to the area2D
	[Export]
	...
	public override void _Ready() {
		...
		if(lastPosition == new Vector2(-1000, -1000)) {
			Stop();
		}
	}
